#ifndef ISISDAEADDRIVER_H
#define ISISDAEADDRIVER_H
 
#include "ADDriver.h"

class isisdaeInterface;

class isisdaeADDriver : public ADDriver 
{
public:
    isisdaeADDriver(const char *portName, int maxSizeX, int maxSizeY, NDDataType_t dataType,
