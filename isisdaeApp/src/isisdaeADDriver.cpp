...
#include "isisdaeADDriver.h"

static const char *driverName = "isisdaeADDriver";
...
template <typename epicsType> int isisdaeADDriver::computeArray(int sizeX, int sizeY)
{
    int simMode=0;
...
/** Template function to compute the simulated detector data for any data type */
template <typename epicsType> int isisdaeADDriver::computeLinearRampArray(int sizeX, int sizeY)
{
...
template <typename epicsType> int isisdaeADDriver::computePeaksArray(int sizeX, int sizeY)
{
...
/** Template function to compute the simulated detector data for any data type */
template <typename epicsType> int isisdaeADDriver::computeSineArray(int sizeX, int sizeY)
{
    epicsType *pMono=NULL, *pRed=NULL, *pGreen=NULL, *pBlue=NULL;
    int columnStep=0, rowStep=0, colorMode;
    int status = asynSuccess;
...
void isisdaeADDriver::setShutter(int open)
{
    int shutterMode;
...
int isisdaeADDriver::computeImage()
{
    int status = asynSuccess;
...
{
    isisdaeADDriver *pPvt = (isisdaeADDriver *)drvPvt;
...
asynStatus isisdaeADDriver::writeInt32(asynUser *pasynUser, epicsInt32 value)
{
...
/** Called when asyn clients call pasynFloat64->write().
  ...
  * \param[in] pasynUser pasynUser structure that encodes the reason and address.
  * \param[in] value Value to write. */
asynStatus isisdaeADDriver::writeFloat64(asynUser *pasynUser, epicsFloat64 value)
{
    int function = pasynUser->reason;
    asynStatus status = asynSuccess;
...
/** Report status of the driver.
  ...
  */
void isisdaeADDriver::report(FILE *fp, int details)
{
...
/** Constructor for isisdaeADDriver; most parameters are simply passed to ADDriver::ADDriver.
  ...
  */
isisdaeADDriver::isisdaeADDriver(const char *portName, int maxSizeX, int maxSizeY, NDDataType_t dataType,
...
{
    int status = asynSuccess;
    const char *functionName = "isisdaeADDriver";
...
extern "C" int isisdaeADConfigure(const char *portName, int maxSizeX, int maxSizeY, int dataType,
                                 int maxBuffers, int maxMemory, int priority, int stackSize)
{
    new isisdaeADDriver(portName, maxSizeX, maxSizeY, (NDDataType_t)dataType,
...
static const iocshArg isisdaeADConfigureArg0 = {"Port name", iocshArgString};
static const iocshArg isisdaeADConfigureArg1 = {"Max X size", iocshArgInt};
static const iocshArg isisdaeADConfigureArg2 = {"Max Y size", iocshArgInt};
static const iocshArg isisdaeADConfigureArg3 = {"Data type", iocshArgInt};
static const iocshArg isisdaeADConfigureArg4 = {"maxBuffers", iocshArgInt};
static const iocshArg isisdaeADConfigureArg5 = {"maxMemory", iocshArgInt};
static const iocshArg isisdaeADConfigureArg6 = {"priority", iocshArgInt};
static const iocshArg isisdaeADConfigureArg7 = {"stackSize", iocshArgInt};
static const iocshArg * const isisdaeADConfigureArgs[] =  {&isisdaeADConfigureArg0,
                                                          &isisdaeADConfigureArg1,
                                                          &isisdaeADConfigureArg2,
                                                          &isisdaeADConfigureArg3,
                                                          &isisdaeADConfigureArg4,
                                                          &isisdaeADConfigureArg5,
                                                          &isisdaeADConfigureArg6,
                                                          &isisdaeADConfigureArg7};
static const iocshFuncDef configureisisdaeAD = {"isisdaeADConfigure", 8, isisdaeADConfigureArgs};
static void configureisisdaeADCallFunc(const iocshArgBuf *args)
{
    isisdaeADConfigure(args[0].sval, args[1].ival, args[2].ival, args[3].ival,
                      args[4].ival, args[5].ival, args[6].ival, args[7].ival);
}


static void isisdaeADRegister(void)
{

    iocshRegister(&configureisisdaeAD, configureisisdaeADCallFunc);
}

extern "C" {
epicsExportRegistrar(isisdaeADRegister);
}
